...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="カウントアップ",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC21カウントアップ11AppDelegate")
...
SWIFT_CLASS("_TtC21カウントアップ13SceneDelegate")
...
SWIFT_CLASS("_TtC21カウントアップ14ViewController")
@interface ViewController : UIViewController
@property (nonatomic, strong) IBOutlet UIImageView * _Null_unspecified UIImageviewA;
